              ...
              <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <?= form_open_multipart('admin/setting/tambah_dokumen') ?>
                    ...
                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">Nama dokumen</label>
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <?php if($setting){  $no=1; foreach($setting as $key){ ?>
                  ...
                  <td>
                    ...
                    <div class="modal fade" id="editdata<?php echo($no); ?>" tabindex="-1">
                      <div class="modal-dialog modal-lg modal-dialog-scrollable">
                        <div class="modal-content">
                          <div class="modal-header">
                            <h5 class="modal-title">Detail Data dokumen</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          </div>
                          <div class="modal-body">
                            <?= form_open_multipart('admin/setting/update_dokumen') ?>
                            <input type="hidden" name="id_dokumen" value="<?php echo $key->id_dokumen; ?>">
                  ...
                  <a   href="<?php echo site_url('admin/setting/delete_dokumen/'.$key->id_dokumen) ?>" class="btn btn-danger btn-sm " onclick="return confirm('Apakah Anda Yakin Akan Menghapus!')"><i class="bi bi-trash"></i> Hapus</a>
