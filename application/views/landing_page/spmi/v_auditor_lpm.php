    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-9">
          ...
          <h3>Profil SPMI</h3>
          <p><?= is_array($auditor) ? $auditor['auditor_lpm'] : $auditor; ?></p>

          <?php if (is_array($foto_auditor) && isset($foto_auditor['foto_auditor'])) : ?>
          <center>
            <img width="700" height="600" src="<?= base_url('uploads/foto_auditor/') . $foto_auditor['foto_auditor']; ?>" alt="Foto LPM" class="img-fluid">
          </center>
        <?php endif; ?>
