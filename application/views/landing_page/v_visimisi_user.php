...
<div class="hero overlay inner-page">
  ...
  <div class="container">
    <div class="row align-items-center justify-content-center text-center pt-5">
      <div class="col-lg-6">
        <h1 class="heading text-white mb-3" data-aos="fade-up" data-aos-delay="100">Visi Misi & Tujuan <br><?= get_setting_data()[0]->sub_web; ?></h1>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container article">
    <div class="row justify-content-center align-items-stretch">
      ...
      <article class="col-lg-8 order-lg-2 px-lg-5">
        ...
        <div class="mb-5">
            <h2 class="text-black h4">Visi, Misi & Tujuan</h2>
          </div>
          <div class="d-flex mb-3 service-alt">
            <div>
              <span class="bi-clipboard2 me-4"></span>
            </div>
            <div>
              <h3>Visi</h3>
              <p><?= is_array($visi) ? $visi['visi'] : $visi; ?></p>
            </div>
          </div>

          <div class="d-flex mb-3 service-alt">
            <div>
              <span class="bi-calendar2-x me-4"></span>
            </div>
            <div>
              <h3>Misi</h3>
              <p><?= is_array($misi) ? $misi['misi'] : $misi; ?></p>
            </div>
          </div>

          <div class="d-flex mb-3 service-alt">
            <div>
              <span class="bi-clipboard-check me-4"></span>
            </div>
            <div>
              <h3>Tujuan</h3>
              <p><?= is_array($tujuan) ? $tujuan['tujuan'] : $tujuan; ?></p>
            </div>
          </div>
