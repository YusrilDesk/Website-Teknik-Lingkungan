...
<section id="blog" class="blog">
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <form action="<?= base_url('layanan/tambah_Alumni') ?>" method="post" role="form">
      ...
      <div class="row">
        ...
        <div class="col-md-6 form-group mt-3 mt-md-0">
          <select class="form-select" aria-label="Default select example" name="jenis_layanan" autocomplete="off" required="required">

            <option value=""> Pilih Jenis Layanan : </option>

            <?php 

            $kategori = array('Permasalahan Email Universitas','Lainnya (Tulis Di Deskripsi)');

            for($c=0; $c < count($kategori); $c++){

              if($kategori[$c] == $sopEdit[0]->jenis_layanan){
