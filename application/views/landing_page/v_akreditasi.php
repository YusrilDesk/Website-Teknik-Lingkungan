...
<div class="hero overlay inner-page">
  ...
  <div class="container">
    <div class="row align-items-center justify-content-center text-center pt-5">
      <div class="col-lg-6">
        <h1 class="heading text-white mb-3" data-aos="fade-up" data-aos-delay="100">Akreditasi <?= get_setting_data()[0]->sub_web; ?></h1>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="container article">
    <div class="row justify-content-center align-items-stretch">
      ...
      <article class="col-lg-8 order-lg-2 px-lg-5">
        ...
        <h2 class="text-black h4">Akreditasi <?= get_setting_data()[0]->sub_web; ?></h2>
        <p ><?= is_array($akreditasi) ? $akreditasi['akreditasi'] : $akreditasi; ?></p>
      ...
      <div class="col-lg-4 mb-5 mb-lg-0 order-lg-3">
        <h2>Pengumuman <i class="bi bi-megaphone"></i></h2>
        <div class="mb-4">
